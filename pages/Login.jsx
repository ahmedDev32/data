...
const SingUp = () => {
  ...
  let HandleSubmit = async(e) =>{
         e.preventDefault()
           const response = await SignUp(user,"login");
        ...
        <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={HandleSubmit}>
              ...
              <button type="submit" className="w-full text-white bg-gray-600 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">Login</button>
              <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                Do Not have an account? <Link href="/SignUp" className="font-medium text-gray-600 hover:underline dark:text-primary-500">
                    Sign Up here</Link>
              </p>
            </form>
          </div>
